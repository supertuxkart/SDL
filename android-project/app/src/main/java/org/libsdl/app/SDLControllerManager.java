...
public class SDLControllerManager
{
    ...
    public static native int onNativePadDown(int device_id, int keycode, int scan_code, int repeat_count);
    public static native int onNativePadUp(int device_id, int keycode, int scan_code);
