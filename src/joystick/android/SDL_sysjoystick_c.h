...
extern int Android_OnPadDown(int device_id, int keycode, int scan_code, int repeat_count);
extern int Android_OnPadUp(int device_id, int keycode, int scan_code);
